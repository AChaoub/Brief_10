...
<head>
    ...
    <link rel="stylesheet" href="../css/PageStock.css">
        ...
        <div id="Header">
            ...
            <div id="HeaderWithoutLogo">
                ...
                <div id="Moncompte">
                    ...
                    <p><a href="pageconnexion.php"> Deconnexion</a> </p>
                </div>
                <div id="Gestion">
                    <img class="profil" src="../img/Stock.png" alt="">
                    <p><a href="pageStock.php"> Gestion Stock</a></p>
